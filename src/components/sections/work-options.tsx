        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative h-80 w-full hidden md:block">
            <Image
              ...
              data-ai-hint="work process"
            />
          </div>
        </div>

        <div className="space-y-16">
            {/* Time & Material Section */}
            ...
            {/* Fixed Price Section */}
            <div className="grid md:grid-cols-2 gap-16 items-start">
                <div className="relative h-80 w-full row-start-2 md:row-start-1">
                    <Image
                        src="https://placehold.co/500x320.png"
                        alt="Fix price"
                        fill
                        style={{ objectFit: 'contain' }}
                        data-ai-hint="fixed price"
                    />
                </div>
                <div className="space-y-6 row-start-1 md:row-start-1">
                    <Card className="border border-border/20 p-6">
                        <CardHeader className="p-0 mb-4">
